...
- [O que é Internet?](https://www.youtube.com/watch?v=Dxcc6ycZ73M)
...
Tradução: _“Não aprenda jQuery, aprenda o DOM. Não aprenda SASS, aprenda CSS. Não aprenda JSX, aprenda HTML. Não aprenda TypeScript, aprenda JavaScript. Não aprenda Handlebars, aprenda JavaScript ES6 templates. Não use apenas o Bootstrap, aprenda padrões de interface do usuário. "_.
...
E se você é alguém que ama ler livros, o [EloquentJavaScript](https://eloquentjavascript.net/) pode ser uma ótima escolha.
...
Tradução: _“Os princípios de design são conselhos fundamentais para você criar designs agradáveis e fáceis de usar.”_.
...
- **Ferramentas de Build**: essa fase é um pouco mais complexa, pois você precisará se aprofundar no JavaScript. Aprenda sobre o [Webpack](https://webpack.js.org/) e também a fazer lint do código usando [ESLint](https://eslint.org/) e formatar ele com [Prettier](https://prettier.io/). Para mim, esse será o último passo antes de passar para o aprendizado avançado.
...
De acordo com a [pesquisa da StackOverflow de 2021](https://insights.stackoverflow.com/survey/2021#section-most-popular-technologies-programming-scripting-and-markup-languages), JavaScript é a linguagem de programação mais popular:
...
Tradução: _"JovaScript completa seu nono ano consecutivo como a linguagem de programação mais usada. Para muitos desenvolvedores, programação é programação web.”_

[JavaScript também é a linguagem dos repositórios mais ativos no Github](https://githut.info/). E esse outro [relatório do Github chamado Octoverse](https://octoverse.github.com/#top-languages-over-the-years), JavaScript também se mostra como uma das principais linguagens ao longo dos anos.
...
Agora é hora de se envolver com certos frameworks. Existem várias opções, mas [um dos frameworks web mais famosos atualmente é o React](https://insights.stackoverflow.com/survey/2021#section-most-popular-technologies-web-frameworks) (mas você também pode aprender Angular ou Vue).
...
O React é um sistema enorme e você poderá estar no topo das ferramentas mais usadas desse tempo: [NextJS](https://nextjs.org/), [GatsbyJS](https://www.gatsbyjs.org/) e aplicativos móveis com o [React Native](https://reactnative.dev/), por exemplo.

### Continue aprendendo

> “To infinity and beyond”.

Tradução: _"Ao infinito e além."_
